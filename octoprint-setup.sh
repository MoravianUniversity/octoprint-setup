...
echo "Adding appropriate settings for octolapse..."
wget -O "$HOME/.octoprint/data/octolapse/settings.json" "https://raw.githubusercontent.com/MoravianUniversity/octoprint-setup/octolapse-settings.json"
